...
fibonacci = """
0       read r1         # Get n
1       setn r2 0       # have r2=0
2       setn r3 1       # have r3=1
3       jeqzn r1 10     # if r1=0 end program
4       write r2        # output r2
5       copy r4 r2      # set r4=r2
6       copy r2 r3      # change r2 value to r3
7       add r3 r4 r3    # change r3 value to r4+r3
8       addn r1 -1      # decrement r1
9       jumpn 3         # jump to base case
10      halt            # end program
